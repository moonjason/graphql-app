...
const { 
    ...
    GraphQLInt,
    GraphQLList, // an array to grab multiple things??
    GraphQLNonNull //we're not gonna accept a null value for certain fields 
...
const Mutation = new GraphQLObjectType({
    name: 'Mutation',
    fields: {
        addAuthor: { // function name to add an author
            type: AuthorType,
            args: {
